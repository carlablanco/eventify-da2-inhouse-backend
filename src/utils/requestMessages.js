const requestMessages = {
  ...
  3: {
    statusHttp: 404,
    message: "Ocurrió un error al buscar el mail del usuario",
  },
  4: { statusHttp: 409, message: "Email existente" },
  5: {
    statusHttp: 500,
    message: "Error ocurrido durante la creación del usuario",
  },
  ...
  11: {
    statusHttp: 500,
    message: "Error ocurrido durante la búsqueda del usuario",
  },
