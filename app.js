...
const swaggerOptions = {
    swaggerDefinition: {
        info: {
            ...
            description: 'API Documentation for the Eventify project that is part of Integracion de Aplicaciones',
            contact: {
...
app.use('/api/v1/', swaggerUi.serve, swaggerUi.setup(swaggerJsdoc(swaggerOptions)));
